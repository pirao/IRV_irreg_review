...
class multivariate_importance():
    def __init__(self, X_train, X_test, y_train, y_test, nmodels=6):
        ...
        mod6 = xgb.XGBRegressor(seed=123,random_state=0, n_jobs=-1)
    ...
    def plot(self, relative=True, topn=8, absolute=True, plot_R2=True):
        ...
        if plot_R2:
            ...
            ax[0, 0].set_title(
                'Linear Regression w/ Lasso - $R^2$ = {}'.format(self.model_r2[0]), fontsize=26)
            ax[0, 1].set_title(
                'RandomForestRegressor - $R^2$ = {}'.format(self.model_r2[1]), fontsize=26)
            ax[0, 2].set_title(
                'AdaBoostRegressor - $R^2$ = {}'.format(self.model_r2[2]), fontsize=26)
            ax[1, 0].set_title(
                'GradientBoostingRegressor - $R^2$ = {}'.format(self.model_r2[3]), fontsize=26)
            ax[1, 1].set_title(
                'ExtraTreesRegressor - $R^2$ = {}'.format(self.model_r2[4]), fontsize=26)
            ax[1, 2].set_title(
                'XGBoost - $R^2$ = {}'.format(self.model_r2[5]), fontsize=26)
            ...
            # ax[0, 0].set_xticklabels(ax[0, 0].get_xmajorticklabels(), fontsize=18)
            # ax[0, 1].set_xticklabels(ax[0, 1].get_xmajorticklabels(), fontsize = 18)
            # ax[0, 2].set_xticklabels(ax[0, 2].get_xmajorticklabels(), fontsize = 18)
            # ax[1, 0].set_xticklabels(ax[1, 0].get_xmajorticklabels(), fontsize=18)
            # ax[1, 1].set_xticklabels(ax[1, 1].get_xmajorticklabels(), fontsize=18)
            # ax[1, 2].set_xticklabels(ax[1, 2].get_xmajorticklabels(), fontsize = 18)
            
            # ax[0, 0].set_yticklabels(ax[0, 0].get_xmajorticklabels(), fontsize=18)
            # ax[0, 1].set_yticklabels(ax[0, 1].get_xmajorticklabels(), fontsize = 18)
            # ax[0, 2].set_yticklabels(ax[0, 2].get_xmajorticklabels(), fontsize = 18)
            # ax[1, 0].set_yticklabels(ax[1, 0].get_xmajorticklabels(), fontsize=18)
            # ax[1, 1].set_yticklabels(ax[1, 1].get_xmajorticklabels(), fontsize=18)
            # ax[1, 2].set_yticklabels(ax[1, 2].get_xmajorticklabels(), fontsize = 18)
